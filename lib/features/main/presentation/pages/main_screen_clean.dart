...
class MainScreenClean extends StatefulWidget {
  final Widget child;

  const MainScreenClean({super.key, required this.child});

  @override
  State<MainScreenClean> createState() => _MainScreenCleanState();
}

class _MainScreenCleanState extends State<MainScreenClean> {
  UserBloc? _userBloc;
