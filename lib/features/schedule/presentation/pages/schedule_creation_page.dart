...
class _ScheduleCreationPageState extends State<ScheduleCreationPage> {
  ...
  void initState() {
    super.initState();
    AppLogger.widgetBuild('ScheduleCreationPage', data: {'action': 'initState'});
    _setDefaultTimes();
  }
  ...
  void _saveSchedule() {
    ...
    if (_isDefault) {
      ...
      AppLogger.blocEvent('ScheduleBloc', 'UnsetAllDefaultSchedules', data: {'reason': 'New default schedule created'});
    }
  }
